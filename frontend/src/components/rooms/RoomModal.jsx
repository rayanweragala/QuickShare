          ...
          {activeTab === "files" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-sm text-neutral-400">Storage Usage</p>
                ...
                {(!room.creatorOnlyUpload || isCreator) && (
                  <button className="px-4 py-2 bg-green-600/80 hover:bg-green-600 text-white font-semibold rounded-lg transition-all flex items-center gap-2">
                ...
                <div className="space-y-2">
                  {files.map((file) => (
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-xs text-neutral-500">
                            ...
                            <span>•</span>
                            <span>by {file.uploaderAnimalName}</span>
                            <span>•</span>
                      ...
                      <button className="p-2 hover:bg-green-500/20 rounded-lg text-green-400 transition-all flex-shrink-0">
